        ...
        <div class="row">
            ...
            <div class="col-6" id="izvodjaci-container">
                ...
                while ($rez = mysqli_fetch_assoc($rezultat)) {
                    ...
                    echo '<form method="GET" action="php\izbrisiKartu.php">';
                    echo '<input type="hidden" name="kartaID" value="' . $rez["kartaID"] . '">';
                    echo '<button type="submit" class="btn btn-primary delete-button">Izbrisi</button>';
                    echo '</form>';
                    echo '<a href="izmeniKartu.php?kartaID=' . $rez["kartaID"] . '" class="btn btn-primary edit-button">Edituj</a>';
                    echo '</div>';
                    echo '</div>';
                    echo '<p>';
                }
